    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="px-4 py-3 border-b border-gray-100">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-900">{MOCK_RESTAURANT.name}</h1>
                  <div className="flex items-center gap-3 text-sm text-gray-600 mt-0.5">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span>{MOCK_RESTAURANT.estimatedDeliveryTime}</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        {selectedCategory === 'all' ? (
          ...
          MOCK_CATEGORIES.map(category => {
            const categoryItems = MOCK_MENU_ITEMS.filter(item => item.categoryId === category.id);
