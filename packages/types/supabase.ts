...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      printers: {
        Row: {
          ...
          organization_id: string
          port: number | null
          print_all_items: boolean | null
          print_settings: Json | null
          printer_type: Database["public"]["Enums"]["printer_type"] | null
          purpose: Database["public"]["Enums"]["printer_purpose"] | null
          updated_at: string | null
    ...
    Enums: {
      delivery_method: "restaurant" | "customer_arranged"
      fulfillment_type: "asap" | "scheduled"
      modifier_type: "size" | "addon" | "removal" | "choice"
      order_status:
        | "pending"
        | "confirmed"
        | "preparing"
      ...
      printer_purpose: "kitchen" | "customer" | "both"
